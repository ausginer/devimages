...
This image extends `ghcr.io/ausginer/devimages/rust`. It inherits the complete Rust, WASM, language, agent, editor, and command-line toolset documented in [`../rust/README.md`](../rust/README.md), then adds the X11, Wayland, udev, keyboard, and ALSA development libraries needed to compile Bevy applications on Linux.
