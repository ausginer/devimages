...
- `bevy-dev`: Linux native libraries needed to build Bevy applications
...
- `rust-dev`: native build dependencies, Rust components and targets, Cargo tools, and Wasmtime
